    ...
    <main id="preview" class="preview">
        ...
        <footer>
            <select id="loop_mode" v-model="loop_mode" @change="changeLoopMode()">
                <option id="auto" value="Auto">自动</option>
                <option id="looping" value="Looping">周期循环</option>
                <option id="once" value="Once">单次周期</option>
            </select>
            <select id="parent_mode" v-model="parent_mode" @change="changeParentMode()">
                <option id="world" value="World">世界</option>
                <option id="entity" value="Entity">实体</option>
                <option id="locator" value="Locator">定位器</option>
            </select>
...
<script>
    ...
    View.screenshot = function() {
        ...
        download.download = `partical_effect_screenshot.png`;
